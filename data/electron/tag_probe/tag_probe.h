...
// Mon Jul 10 15:31:54 2017 by ROOT version 6.06/08
...
#ifdef tag_probe_cxx
tag_probe::tag_probe(TTree *tree) : fChain(0) 
{
...
Int_t tag_probe::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t tag_probe::LoadTree(Long64_t entry)
{
...
void tag_probe::Init(TTree *tree)
{
...
void tag_probe::Show(Long64_t entry)
{
...
Int_t tag_probe::Cut(Long64_t entry)
{
