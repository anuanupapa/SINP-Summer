...
// Wed Jul 12 17:56:38 2017 by ROOT version 6.06/08
// from TTree EventTree/Event data (tag V08_00_26_03)
// found on file: ggtree_mc.root
//////////////////////////////////////////////////////////

#ifndef tag_probe_gaus_h
#define tag_probe_gaus_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   tag_probe_gaus(TTree *tree=0);
   virtual ~tag_probe_gaus();
...
#ifdef tag_probe_gaus_cxx
tag_probe_gaus::tag_probe_gaus(TTree *tree) : fChain(0) 
{
...
tag_probe_gaus::~tag_probe_gaus()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t tag_probe_gaus::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t tag_probe_gaus::LoadTree(Long64_t entry)
{
...
void tag_probe_gaus::Init(TTree *tree)
{
...
void tag_probe_gaus::Show(Long64_t entry)
{
...
Int_t tag_probe_gaus::Cut(Long64_t entry)
{
...
#endif // #ifdef tag_probe_gaus_cxx
