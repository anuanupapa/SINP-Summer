...
// Wed Jul  5 18:36:53 2017 by ROOT version 6.06/08
...
#ifdef trans_mom_cxx
trans_mom::trans_mom(TTree *tree) : fChain(0) 
{
...
Int_t trans_mom::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t trans_mom::LoadTree(Long64_t entry)
{
...
void trans_mom::Init(TTree *tree)
{
...
void trans_mom::Show(Long64_t entry)
{
...
Int_t trans_mom::Cut(Long64_t entry)
{
