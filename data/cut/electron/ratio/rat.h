...
// Sun Jul  9 12:21:48 2017 by ROOT version 6.06/08
...
Int_t rat::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t rat::LoadTree(Long64_t entry)
{
...
Bool_t rat::test(Int_t a)
{
  if(fabs(eleSCEta->at(a))<1.479 && eleHoverE->at(a)<0.0414 && eleSigmaIEtaIEtaFull5x5->at(a)<0.00998 &&  eleMissHits->at(a)<=1 && eleConvVeto->at(a)==1 && elePt->at(a)>10 && fabs(eleEoverPInv->at(a))<0.0129 && fabs(eledEtaAtVtx->at(a))<\
     0.00308 && fabs(eledPhiAtVtx->at(a))<0.0816)
    {
      return true;
    }
  else if(1.479 < abs(eleSCEta->at(a))  && abs(eleSCEta->at(a))< 2.4 && eleHoverE->at(a)<0.0641 &&  eleSigmaIEtaIEtaFull5x5->at(a)<0.0292 && eleMissHits->at(a)<=1 &&  eleConvVeto->at(a)==1 && elePt->at(a)>10 && fabs(eleEoverPInv->at(a))<\
	  0.0129 && fabs(eledEtaAtVtx->at(a))<0.00605 && fabs(eledPhiAtVtx->at(a))<0.0394)
    {
      return true;
    }
  else
