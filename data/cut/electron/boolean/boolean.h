...
// Fri Jul 21 10:20:00 2017 by ROOT version 6.06/08
...
#ifdef boolean_cxx
boolean::boolean(TTree *tree) : fChain(0) 
{
...
Int_t boolean::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t boolean::LoadTree(Long64_t entry)
{
...
void boolean::Show(Long64_t entry)
{
...
Int_t boolean::Cut(Long64_t entry)
{
