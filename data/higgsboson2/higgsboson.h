...
// Tue Jul 25 15:16:13 2017 by ROOT version 6.06/08
...
#ifdef higgsboson_cxx
higgsboson::higgsboson(TTree *tree) : fChain(0) 
{
...
Int_t higgsboson::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t higgsboson::LoadTree(Long64_t entry)
{
...
void higgsboson::Init(TTree *tree)
{
...
void higgsboson::Show(Long64_t entry)
{
...
Int_t higgsboson::Cut(Long64_t entry)
{
