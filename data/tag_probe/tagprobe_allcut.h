...
// Sun Jul 23 12:03:55 2017 by ROOT version 6.06/08
// from TTree EventTree/Event data (tag V08_00_26_03)
// found on file: ggtree_mc.root
//////////////////////////////////////////////////////////

#ifndef tagprobe_allcut_h
#define tagprobe_allcut_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   tagprobe_allcut(TTree *tree=0);
   virtual ~tagprobe_allcut();
   ...
   virtual Bool_t   test(Int_t a);
};

#endif

#ifdef tagprobe_allcut_cxx
tagprobe_allcut::tagprobe_allcut(TTree *tree) : fChain(0) 
{
...
tagprobe_allcut::~tagprobe_allcut()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t tagprobe_allcut::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t tagprobe_allcut::LoadTree(Long64_t entry)
{
...
void tagprobe_allcut::Init(TTree *tree)
{
...
void tagprobe_allcut::Show(Long64_t entry)
{
...
Int_t tagprobe_allcut::Cut(Long64_t entry)
{
...
Bool_t tagprobe_allcut::test(Int_t a)
{
  if(fabs(eleSCEta->at(a))<1.479 && eleHoverE->at(a)<0.0414 && eleSigmaIEtaIEtaFull5x5->at(a)<0.00998 &&  eleMissHits->at(a)<=1 && eleConvVeto->at(a)==1 && elePt->at(a)>10 && fabs(eleEoverPInv->at(a))<0.0129 && fabs(eledEtaAtVtx->at(a))<0.00308 && fabs(eledPhiAtVtx->at(a))<0.0816)
    {
      return true;
    }
  else if(1.479 < abs(eleSCEta->at(a))  && abs(eleSCEta->at(a))< 2.4 && eleHoverE->at(a)<0.0641 &&  eleSigmaIEtaIEtaFull5x5->at(a)<0.0292 && eleMissHits->at(a)<=1 &&  eleConvVeto->at(a)==1 && elePt->at(a)>10 && fabs(eleEoverPInv->at(a))<0.0129 && fabs(eledEtaAtVtx->at(a))<0.00605 && fabs(eledPhiAtVtx->at(a))<0.0394)
    {
      return true;
    }
  else
...
#endif // #ifdef tagprobe_allcut_cxx
