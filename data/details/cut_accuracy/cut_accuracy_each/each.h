...
// Fri Jul 21 16:23:08 2017 by ROOT version 6.06/08
...
Int_t each::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t each::LoadTree(Long64_t entry)
{
