...
// Fri Jul 21 11:50:20 2017 by ROOT version 6.06/08
// from TTree EventTree/Event data (tag V08_00_26_03)
// found on file: ggtree_mc.root
//////////////////////////////////////////////////////////

#ifndef cutaccuracy_h
#define cutaccuracy_h
...
#ifdef cutaccuracy_cxx
cutaccuracy::cutaccuracy(TTree *tree) : fChain(0) 
{
...
Int_t cutaccuracy::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t cutaccuracy::LoadTree(Long64_t entry)
{
...
void cutaccuracy::Init(TTree *tree)
{
...
void cutaccuracy::Show(Long64_t entry)
{
...
Int_t cutaccuracy::Cut(Long64_t entry)
{
...
Bool_t cutaccuracy::test(Int_t a)
{
