...
// Mon Jul 10 12:40:13 2017 by ROOT version 6.06/08
...
#ifdef detail1_cxx
detail1::detail1(TTree *tree) : fChain(0) 
{
...
Int_t detail1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t detail1::LoadTree(Long64_t entry)
{
...
void detail1::Show(Long64_t entry)
{
...
Int_t detail1::Cut(Long64_t entry)
{
