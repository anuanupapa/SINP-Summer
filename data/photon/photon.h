...
// Thu Jul  6 21:29:09 2017 by ROOT version 6.06/08
...
#ifdef photon_cxx
photon::photon(TTree *tree) : fChain(0) 
{
...
Int_t photon::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t photon::LoadTree(Long64_t entry)
{
...
void photon::Show(Long64_t entry)
{
...
Int_t photon::Cut(Long64_t entry)
{
