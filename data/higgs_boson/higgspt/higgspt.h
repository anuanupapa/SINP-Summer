...
// Sun Jul 23 20:38:53 2017 by ROOT version 6.06/08
...
#ifdef higgspt_cxx
higgspt::higgspt(TTree *tree) : fChain(0) 
{
...
Int_t higgspt::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t higgspt::LoadTree(Long64_t entry)
{
...
void higgspt::Show(Long64_t entry)
{
...
Int_t higgspt::Cut(Long64_t entry)
{
