...
// Fri Jul 14 12:07:00 2017 by ROOT version 6.06/08
...
#ifdef higgs_boson_cxx
higgs_boson::higgs_boson(TTree *tree) : fChain(0) 
{
...
Int_t higgs_boson::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t higgs_boson::LoadTree(Long64_t entry)
{
...
void higgs_boson::Init(TTree *tree)
{
...
void higgs_boson::Show(Long64_t entry)
{
...
Int_t higgs_boson::Cut(Long64_t entry)
{
