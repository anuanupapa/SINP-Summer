...
// Sat Aug 19 15:48:36 2017 by ROOT version 6.06/08
// from TTree EventTree/Event data (tag V08_00_26_03)
// found on file: ggtree_mc.root
//////////////////////////////////////////////////////////

#ifndef cut_study_2_h
#define cut_study_2_h
...
#ifdef cut_study_2_cxx
cut_study_2::cut_study_2(TTree *tree) : fChain(0) 
{
...
cut_study_2::~cut_study_2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t cut_study_2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t cut_study_2::LoadTree(Long64_t entry)
{
...
void cut_study_2::Init(TTree *tree)
{
...
void cut_study_2::Show(Long64_t entry)
{
...
Int_t cut_study_2::Cut(Long64_t entry)
{
...
Bool_t cut_study_2::test(Int_t a)
{
