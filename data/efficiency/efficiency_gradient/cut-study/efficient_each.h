...
// Mon Oct  9 14:24:51 2017 by ROOT version 6.06/08
// from TTree EventTree/Event data (tag V08_00_26_03)
// found on file: ggtree_mc.root
//////////////////////////////////////////////////////////

#ifndef efficient_each_h
#define efficient_each_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   efficient_each(TTree *tree=0);
   virtual ~efficient_each();
...
#ifdef efficient_each_cxx
efficient_each::efficient_each(TTree *tree) : fChain(0) 
{
...
efficient_each::~efficient_each()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t efficient_each::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t efficient_each::LoadTree(Long64_t entry)
{
...
void efficient_each::Init(TTree *tree)
{
...
void efficient_each::Show(Long64_t entry)
{
...
Int_t efficient_each::Cut(Long64_t entry)
{
...
Bool_t efficient_each::test(Int_t a)
{
...
#endif // #ifdef efficient_each_cxx
