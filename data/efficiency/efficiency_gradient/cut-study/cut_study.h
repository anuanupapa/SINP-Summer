...
// Sat Aug 19 15:15:48 2017 by ROOT version 6.06/08
...
#ifdef cut_study_cxx
cut_study::cut_study(TTree *tree) : fChain(0) 
{
...
Int_t cut_study::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t cut_study::LoadTree(Long64_t entry)
{
...
void cut_study::Init(TTree *tree)
{
...
void cut_study::Show(Long64_t entry)
{
...
Int_t cut_study::Cut(Long64_t entry)
{
