...
// Thu Oct 12 13:42:56 2017 by ROOT version 6.06/08
...
Int_t cut2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t cut2::LoadTree(Long64_t entry)
{
