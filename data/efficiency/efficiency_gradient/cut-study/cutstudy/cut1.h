...
// Thu Oct 12 13:42:28 2017 by ROOT version 6.06/08
...
Int_t cut1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t cut1::LoadTree(Long64_t entry)
{
