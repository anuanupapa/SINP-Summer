...
// Mon Jul 17 11:00:20 2017 by ROOT version 6.06/08
...
#ifdef bosonpt_cxx
bosonpt::bosonpt(TTree *tree) : fChain(0) 
{
...
Int_t bosonpt::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t bosonpt::LoadTree(Long64_t entry)
{
...
void bosonpt::Show(Long64_t entry)
{
...
Int_t bosonpt::Cut(Long64_t entry)
{
