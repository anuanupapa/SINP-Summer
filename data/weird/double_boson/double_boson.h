...
// Thu Jul 13 10:24:37 2017 by ROOT version 6.06/08
// from TTree EventTree/Event data (tag V08_00_26_03)
// found on file: ggtree_mc.root
//////////////////////////////////////////////////////////

#ifndef double_boson_h
#define double_boson_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   double_boson(TTree *tree=0);
   virtual ~double_boson();
...
#ifdef double_boson_cxx
double_boson::double_boson(TTree *tree) : fChain(0) 
{
...
double_boson::~double_boson()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t double_boson::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t double_boson::LoadTree(Long64_t entry)
{
...
void double_boson::Init(TTree *tree)
{
...
void double_boson::Show(Long64_t entry)
{
...
Int_t double_boson::Cut(Long64_t entry)
{
